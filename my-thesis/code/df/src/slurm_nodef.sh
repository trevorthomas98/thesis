...
#SBATCH -o /home/trevor.thomas/thesis/my-thesis/runs/closedworld_nodef_run.%j.out
...
python3 /home/trevor.thomas/thesis/my-thesis/code/df/src/ClosedWorld_DF_NoDef.py
